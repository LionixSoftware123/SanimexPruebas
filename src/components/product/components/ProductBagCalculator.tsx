...
const ProductBagCalculator: React.FC<ProductBagCalculatorProps> = ({
  product,
  quantity = 0,
  onQuantity = () => {},
  active = true,
  ...
  const calculateData = () => {
    ...
    const amountMtr =
      cleanProductAttributeBagOption(productAttributeBag) / APROX_KG_BY_MTR;
...
export default ProductBagCalculator;
