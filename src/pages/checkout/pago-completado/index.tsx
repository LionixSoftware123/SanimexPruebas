                ...
                <>
                  ...
                  <div className="grid grid-cols-4 my-14">
                    <div className="border-r border-r-[#C1C1C1] p-2">
                      ...
                      <p className="pb-2 font-Century-Gothic text-[12px] text-center">{BancoDetailsBanorte}</p>
                    ...
                    <div className="border-r border-r-[#C1C1C1] p-2">
                      ...
                      <p className="pb-2 font-Century-Gothic text-[12px] text-center">{AccountDetailsBanorte}</p>
                    ...
                    <div className="border-r border-r-[#C1C1C1] p-2">
                      ...
                      <p className="pb-2 font-Century-Gothic text-[12px] text-center">{ClabeDetailsBanorte}</p>
                    ...
                    <div className="p-2 m">
                      ...
                      <p className="flex self-center font-Century-Gothic text-[10px] text-center justify-center items-center">Atención a clientes: <a href={`https://api.whatsapp.com/send?phone=${WhatsApp}`} className=" flex self-center ml-1 w-[20px] h-[20px] md:w-[20px] md:h-[20px] drop-shadow-lg pointer-events-auto"
